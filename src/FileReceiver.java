...
public class FileReceiver {
	...
	public static void main(String[] args) throws Exception {
		...
		while (true) {
			try (FileTransfer transfer = new FileTransfer()) {
				...
				Entry<String, Long> meta = transfer.getRequest();
				File file = askUser(meta.getKey(), meta.getValue());
				final boolean success = transfer.receive(file, meta.getValue(), true);
				if (success) {
	...
	private static File askUser(String name, Long size) {
